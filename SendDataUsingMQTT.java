...
public class SendDataUsingMQTT{
	...
	String channel="channels/1084929/publish/5S4XHF5R773T2SO6";
	int qos=0;
	 public  SendDataUsingMQTT() throws MqttException {
	    ...
	    public void publish(String data) throws MqttPersistenceException, MqttException{
	    	...
	    	// Create and configure a message
	   		MqttMessage message = new MqttMessage(data.getBytes()); // le protocole utilisé
	    	message.setQos(qos);
	    	message.setRetained(false);

	    	client.publish(channel, message); // envoyer le les données vers le serveur cloud
